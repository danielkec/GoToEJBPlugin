...
public abstract class TypeProviderAccessor {
    ...
    public abstract TypeProvider.Context createContext(Project p, String text, SearchType t);

    @NonNull
    public abstract TypeProvider.Result createResult(@NonNull Collection<? super TypeDescriptor> result, @NonNull String[] message, @NonNull TypeProvider.Context context);
